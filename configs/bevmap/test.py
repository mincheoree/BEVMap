...
model = dict(
    ...
    img_neck=dict(
        ...
        start_level=0,
        out_ids=[0]),
    img_view_transformer=dict(type='ViewTransformerLiftSplatShoot_Map',
...
train_pipeline = [
    dict(type='LoadMultiViewImageFromFiles_BEVMap', is_train=True, data_config=data_config),
    dict(
...
eval_pipeline = [
    dict(type='LoadMultiViewImageFromFiles_BEVMap', data_config=data_config),
    dict(
        type='DefaultFormatBundle3D',
        class_names=class_names,
        with_label=False),
