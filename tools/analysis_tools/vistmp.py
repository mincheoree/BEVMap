...
def main():
    ...
    # args.root_path ='data/mini'
    args.root_path = 'data/nuscenes/'
    args.version = 'singleval'
    info_path = args.root_path + '/nuscenes_singlevalbevdet_infos.pkl' 
    print(info_path)
    ...
    # canvas = np.ones((int(canva_size), int(canva_size), 3), dtype=np.uint8)
