...
if __name__ == '__main__':
    ...
    bevformer_results = mmcv.load('./results_nusc.json')

    sample_token_list = list(bevformer_results['results'].keys())
    render_sample_data('ca9a282c9e77460f8360f564131a8af5', pred_data=bevformer_results, out_path='ca9a282c9e77460f8360f564131a8af5')
